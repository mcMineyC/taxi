function getSongs(){
    ...
    for (var x = 0; x < songs.length; x++) {
        ...
        document.getElementById("content").innerHTML += '<m3-mediacard image="'+window.prefs.getBackendUrl()+'/info/songs/' + songs[x]["id"] + '/image" text="' + songs[x]["displayName"] + '" onclick="handleSongClick(\'' + songs[x]["id"] + '\')"></m3-mediacard>';
    }
}
