function getAlbums(){
    ...
    for (var x = 0; x < albums.length; x++) {
        ...
        document.getElementById("content").innerHTML += '<m3-mediacard image="'+window.prefs.getUrl()+'/info/albums/' + albums[x]["id"] + '/image" text="' + albums[x]["displayName"] + '" onclick="albumClick(\'' + albums[x]["id"] + '\')"></m3-mediacard>';
    }
}
